...
def main():
    parser = argparse.ArgumentParser(prog="krishnautoml", description="KrishnAutoML CLI")
    ...
    parser.add_argument("--save", type=str, default="best_model.pkl", help="Save best model to file")
